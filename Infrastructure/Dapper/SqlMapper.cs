...
namespace Infrastructure.Dapper
{
    ...
    public struct CommandDefinition
    {
        ...
        /// Should data be buffered before returning?
        /// </summary>
        public bool Buffered { get { return (_flags & CommandFlags.Buffered) != 0; } }

        /// <summary>
        /// Should the plan for this query be cached?
        /// </summary>
        internal bool AddToCache { get { return (_flags & CommandFlags.NoCache) == 0; } }

        /// <summary>
        /// Additional state flags against this command
        /// </summary>
        public CommandFlags Flags { get { return _flags; } }

        /// <summary>
        /// Can async queries be pipelined?
        /// </summary>
        public bool Pipelined { get { return (_flags & CommandFlags.Pipelined) != 0; } }
        ...
        static SqlMapper.Link<Type, Action<IDbCommand>> _commandInitCache;
